...
- [**2025 年与 2026 年 - 归于平静**](#2025%20年与%202026%20年%20-%20归于平静)
- [**写在最后**](#写在最后)
...
<u>“A 营”的全称是**阿儿法营**（Aerfaying），是一个 Scratch 社区</u>。顾名思义，Scratch 社区指的是：一个供用户分享 Scratch（图形化编程）作品、交流 Scratch 技术的网络社区。
...
用户可以在 A 营分享自己的 Scratch 作品。在 A 营中发现用户的新作品主要有两个渠道——主页和发现页。  
主页推荐分为精华作品和热门作品两部分，前者是最近的精华作品，后者由算法根据点赞、观看等数据自动产生；而发现页默认展示最新发布的作品。因此在 A 营中作品的“引流”渠道几乎均由用户而非官方主导，对新用户的发展较为友好。
...
<u>A 营在 2020 年以前就有着**丰富的社区机制和功能**</u>，这些特性丰富了用户的作品创作、交流互动，其主要包括：
...
<u>2020 年上旬，守护煮持续在社区中活跃，和用户建立了良好的关系</u>。一个趣闻是，社区有时无法访问的情况被戏称为“（守护者）把咖啡撒到服务器上了”，守护煮便因此更改了原先的用户名“守护者”为“守护煮”，并推出了咖啡头像挂件，这也是守护煮被称为“煮”的原因。
...
- 挖矿机器人与拍卖行：2020 年 3 月推出，用户通过购买“挖矿机器人”道具来参与类似数字货币挖矿的竞赛活动获得包括金币、经验、矿物道具和图纸道具在内的奖励，矿物道具和图纸道具可以在拍卖行和其它用户交易以获得更多的金币收益。
- 论坛：2020 年 6 月推出，用户可以在论坛中分享文字贴文，补全了社区功能的短板、也为用户提供了更多交流和反馈的空间。
...
<u>社区环境在 2020 年末、2021 年初也发生了变化，A 营的社交属性增加，网恋、“社交帝”（在社区内几乎仅社交而不创作）等现象出现，作品质量、讨论质量开始下降</u>。
...
TFGS 梗文化出现后，社区的讨论氛围开始发生转变，<u>“讽刺文化”发展</u>，一些用户（被称为“<u>城管</u>”）会通过发布讽刺作品、发表讽刺评论等方式表达自己对某些用户及其行为的反对和批评，<u>在一定程度上规范了社区内的某些乱象</u>，<u>但是部分讽刺行为也存在着“矫枉过正”、“跟风讽刺”等问题</u>。
...
2022 年中旬，用户“谰语”由于初入社区即精通 Markdown 语法、获得三级真人认证等原因，被质疑是老用户所创建的小号，而引发了一系列的多方冲突，这一事件直接推动了后续“保护萌新”的工作室知心屋的成立。

7 月，野猪老钱创立了“守护 · 蜕变 · 成长”的组织<u>知心屋</u>，随着知心屋的迅速发展和其内部各种制度的确立，在其初期受到了守护煮和很多用户的支持。

![知心屋基本规定](./aerfaying-history/zhixinwu-rules.png)

但因为知心屋及野猪老钱的行为、观念等方面存在着一定的问题，例如人员筛选不严、过于庇护知心屋成员等，社区中有用户开始反对知心屋和野猪老钱，出现了“知心邪教说”和“窒息说”，认为知心屋“如同邪教”。这些批评反映出了其客观存在的问题、但也存在着一定的煽动性和攻击性。  
...
<u>对野猪老钱的批评逐渐演化为了野猪老钱及其支持者与其反对者的冲突</u>。  
在冲突中，守护煮被认为存在一刀切、偏袒知心屋的行为，例如将官群中讨论相关问题的老用户踢出群，引发了许多用户的不满。

与此同时，一些反对野猪老钱的用户对其本人及知心屋展开了过激的攻击与报复，例如“人肉搜索”并传播野猪老钱的姓名等隐私信息，以及部分具有较大影响力的用户针对野猪老钱合法维权进行了嘲讽与否定，进一步推动了矛盾的激化，这一做法与观点在当时受到了许多用户的追捧，形成了一种恶劣的风气与影响。  
知心屋及野猪老钱方面也作出了一定的过激报复，冲突愈演愈烈，最终走向了难以和解的地步。

![社区中部分影响力较大的用户对野猪老钱的合法维权进行嘲讽与否定，包括称其“拿法律当挡箭牌”、戏仿其维权言论（上图）、鼓吹其“不配拥有民事权利“等](./aerfaying-history/cheese-pizza.png)

最终，<u>该事件以野猪老钱发表道歉声明、退出 A 营收尾，该事件对 A 营造成了一定的冲击</u>，使得社区环境进一步恶化。有 [研究](https://gitblock.cn/Studios/65834/Forum/PostView?postId=36965) 认为，在此之后、参与了该事件的“城管”群体开始走向“腐化”，形成通过开盒、挂人、辱骂“解决问题”的恶劣风气。
...
而在近两年，由于手机、邮箱验证码功能无法正常运行，新用户实际上已经无法通过除邀请以外的方式注册账户了。

### 归于平静

一方面，在社区热度最高的 2020 年上旬、平均每日作品发布量为 117.2 个，而到了 2026 年上旬，这个数字降低到了 2.9 个，减少了 97.5%. 另一方面，近两年社区内已经极少发生恶性事件。这表明社区已然在几年的衰落后“归于平静”。

工作室 [阿儿法信息科技研究所](https://gitblock.cn/Studios/65834) 在社区历史的记录、研究和编撰中起到了重要的作用，这也是这一时期仍保持着较高活跃的工作室之一。

![阿儿法信息科技研究所](./aerfaying-history/institute.png)
...
2020 年 6 月推出的论坛功能使得用户能够分享文字内容，这补全了社区功能的短板，开放的三大论坛——议政厅、论剑峰和萌新客栈也为用户提供了交流和反馈的空间。
